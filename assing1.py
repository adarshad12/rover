...
def thresh_callback(val):
    ...
    for cnt in contours:
        ...
        if len(approx)==4:
            print ("square")
            #cv.drawContours(drawing,[cnt],0,(94,234,255),-1)

        elif len(approx)==8:
	    print("circle")
            #cv.drawContours(drawing,[cnt],0,(220,152,91),-1)
...
parser.add_argument('--input', help='Path to input image.', default='template.png')
